...
public class BoxV2 {
	...
	BoxV2(int x1, int y1, int x2, int y2) {
		this.x1 = x1;
		this.y1 = y1;
		this.x2 = x2;
		this.y2 = y2;
	...
	BoxV2(Point topLeft, Point bottomRight) {
		this(topLeft.x, topLeft.y, bottomRight.x, bottomRight.y);
	}

	BoxV2(Point topLeft, int w, int h) {
	...
	public static void main(String[] arguments) {
		...
		rect = new BoxV2(13, 35, 10, 40);
		rect.printBox();

		System.out.println("\nCalling Box2 with points " + "(9,27) and (17,19):");
		rect = new BoxV2(new Point(9, 27), new Point(17, 19));
		rect.printBox();
		System.out.println("\nCalling Box2 with 1 point " + "(5,40), width 22 and height 20:");
		rect = new BoxV2(new Point(5, 40), 22, 20);
		rect.printBox();
	}
}
